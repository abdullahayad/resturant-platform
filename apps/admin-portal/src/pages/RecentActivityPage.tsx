...
import { UtensilsCrossed, Image as ImageIcon, Percent, CalendarClock } from 'lucide-react'
...
const icons = { dish: UtensilsCrossed, photo: ImageIcon, promotion: Percent, event: CalendarClock }
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          what's changing without reviewing every restaurant one by one.
        </p>
      </div>
            ...
            <div key={`${item.type}-${item.id}`} className="flex items-start gap-3 px-4 py-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-sm">
                  ...
                  <span className="text-muted-foreground">({item.restaurant.codeNumber})</span> {describe(item)}
                </div>
